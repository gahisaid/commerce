...
<?php
			...
			if (!function_exists('colormag_footer_copyright')) :
				...
				function colormag_footer_copyright()
				{
					...
					$default_footer_value = sprintf( /* Translators: %1$s: Current year, %2$s: Site link */esc_html__('Copyright &copy; %1$s %2$s. toutes les droits reservés.', 'Cr-ghessat'), date('Y'), $site_link, $tg_link, 'ThemeGrill') . ' ' . sprintf( /* Translators: %s: WordPress link */esc_html__('', 'colormag'), $wp_link);
